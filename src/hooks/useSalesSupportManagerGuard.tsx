...
// Blocked routes for Sales & Support Manager - SECURITY CRITICAL
...
export const useSalesSupportManagerGuard = () => {
  ...
  useEffect(() => {
    if (checkRouteAccess(location.pathname)) {
      toast.error('Access Denied: This area is restricted for Sales & Support Managers');
      navigate('/sales-support-manager');
    }
